...
for i in range(1, 10):
        ...
        data_path = r"{0}\exp_1_1\data\rule_{1}\mal_training_data.txt".format(dir_path, i)
        data = np.loadtxt(data_path, dtype=float, delimiter=" ")
        major_data_x_mal_part = data
        data_path = r"{0}\exp_1_1\data\rule_{1}\benign_training_data.txt".format(dir_path, i)
        data = np.loadtxt(data_path, dtype=float, delimiter=" ")
